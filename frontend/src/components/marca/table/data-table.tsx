...
import { MarcaDataTableProps } from "@marca/types";

export function DataTableMarca({ columns, data }: MarcaDataTableProps) {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="w-full max-w-3xl mx-auto overflow-auto rounded-md 
        border-4 
